 ...
 * @author nikol
 */
public class VratiUtakmicuPoId extends AbstractGenericOperation {
    ...
    protected Object executeOperation(Object entity) throws Exception {
        ResultSet rs = databaseBroker.vratiPoId((Utakmica) entity);
        ...
        while (rs1.next()) {
            ...
            iu.setIgracId(rs.getInt(1));
            iu.setUtakmicaId(rs.getInt(2));
            iul.add(iu);
        }
        while (rs.next()) {
